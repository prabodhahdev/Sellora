...
const FilterSidebar = ({ showFilterPhone, setFilterPhone, filters, setFilters }) => {
    ...
    bg-white rounded-lg shadow-md border border-gray-100 h-fit sticky top-24 md:min-w-[300px]`}>
            ...
            <div className="p-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={() => setFilterPhone(false)} className="sm:hidden text-sm border text-gray-700 px-3 py-1 rounded ">Apply</button>
                    </div>
                </div>
            </div>
            ...
            <div className="p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar">
                    ...
                    {expandedSections.price && (
                        <div className="space-y-3">
                            <input
                                ...
                                step="100" value={filters.maxPrice || 100000}
                ...
                <div>
                    <button onClick={() => toggleSection("niche")} className="flex items-center justify-between w-full mb-3">
                        <label className="text-sm font-medium text-gray-800" > Niche Range</label>
